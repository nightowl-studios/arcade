...
func (_m *Hub) HandleAuthentication(w http.ResponseWriter, r *http.Request, conn *websocket.Conn, send chan []byte) (identifier.Client, error) {
...
func (_m *Hub) HandleMessage(messageType int, message []byte, clientID identifier.Client, messageErr error) {
	_m.Called(messageType, message, clientID, messageErr)
}

// RegisterClient provides a mock function with given fields: clientID, send
func (_m *Hub) RegisterClient(clientID identifier.Client, send chan []byte) {
	_m.Called(clientID, send)
}

// UnregisterClient provides a mock function with given fields: clientID
func (_m *Hub) UnregisterClient(clientID identifier.Client) bool {
	ret := _m.Called(clientID)

	var r0 bool
	if rf, ok := ret.Get(0).(func(identifier.Client) bool); ok {
		r0 = rf(clientID)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_m *Hub) Upgrader() *websocket.Upgrader {
	ret := _m.Called()
