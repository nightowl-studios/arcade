...
func TestNumberOfUnderscore4(t *testing.T) {
	wordHint := Get()
	wordHint.previousHintIndexes = append(wordHint.previousHintIndexes, 1)
	wordHint.previousHintIndexes = append(wordHint.previousHintIndexes, 2)
	wordHint.previousHintIndexes = append(wordHint.previousHintIndexes, 3)
	wordHint.previousHintIndexes = append(wordHint.previousHintIndexes, 4)
	hint := wordHint.GiveHint("testing")
	assertEqual(t, countUnderscore(hint), 2)
}

func TestNumberOfUnderscore5(t *testing.T) {
	wordHint := Get()
	wordHint.previousHintIndexes = append(wordHint.previousHintIndexes, 1)
	wordHint.previousHintIndexes = append(wordHint.previousHintIndexes, 2)
	wordHint.previousHintIndexes = append(wordHint.previousHintIndexes, 3)
	wordHint.previousHintIndexes = append(wordHint.previousHintIndexes, 4)
	wordHint.previousHintIndexes = append(wordHint.previousHintIndexes, 5)
	hint := wordHint.GiveHint("testing")
	assertEqual(t, countUnderscore(hint), 1)
}
